...
-- 正在导出表  eastbride.shiro_permissions 的数据：~2 rows (大约)
...
-- 正在导出表  eastbride.shiro_roles_permissions 的数据：~4 rows (大约)
...
-- 正在导出表  eastbride.shiro_urls 的数据：~6 rows (大约)
...
-- 正在导出表  eastbride.shiro_urls_type 的数据：~2 rows (大约)
...
-- 正在导出表  eastbride.wx_dev_config 的数据：~0 rows (大约)
...
-- 正在导出表  eastbride.wx_props 的数据：~0 rows (大约)
