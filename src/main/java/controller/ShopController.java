...
import model.shop.ShopGoods;
import model.shop.ShopMenu;
import model.shop.ShopOrder;
import validator.ShopAdminCheck;
...
public class ShopController extends Controller {
	...
	public void userMoney() {
		...
		int pageNumber = getParaToInt("pageNumber", 1);
		int pageSize = getParaToInt("pageSize", 20);
		setAttr("shop_user", Customer.dao.getAllCustomer(pageNumber, pageSize));
