...
import frame.sdk.wechat.msg.InMsgParaser;
import frame.sdk.wechat.msg.OutMsgXmlBuilder;
...
import frame.sdk.wechat.msg.in.InMsg;
...
import frame.sdk.wechat.msg.out.OutMsg;
...
public abstract class WeixinController extends Controller {
	 ...
	 * 刷新公众号菜单
	 */
	public void refreshMenu(String menuStr) {
	...
	// 处理接收到的上报地理位置事件
	protected abstract void processInLocationEvent(
